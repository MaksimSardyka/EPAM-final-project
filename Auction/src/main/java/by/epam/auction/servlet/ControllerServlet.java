...
public class ControllerServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		previousPageOptional = Optional
				.ofNullable((ViewPage) requestContent.getSessionAttributeValue(ParsingValues.PREVIOUS_PAGE));
		...
		requestContent.insertSessionAttribute(ParsingValues.NONCE, UUID.randomUUID().toString());
