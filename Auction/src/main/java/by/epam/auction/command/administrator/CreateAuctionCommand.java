...
/**
 * The Class CreateAuctionCommand.
 */
public class CreateAuctionCommand implements Command {
	...
	/**
	 * Instantiates a new creates the auction command.
	 *
	...
	/**
	 * Executes CreateAuctionCommand with the data parsed from the
	...
	public ViewPage execute(SessionRequestContent requestContent) {
		...
		if (user != null && user.getRole() == Role.ADMINISTRATOR) {
			try {
				...
				String description = new ExtractorImpl<String>().extract(descriptionParser, ParsingValues.AUCTION_DESCRIPTION,
						requestContent);
