...
public class ApproveLotCommand implements Command {
	...
	/**
	 * Instantiates a new approve lot command.
	 *
	 * @param service
	 *            the service
	 */
	...
	/**
	 * Executes ApproveLotCommand with the data parsed from the
	 * SessionRequestContent content
	 */
	@Override
	public ViewPage execute(SessionRequestContent requestContent) {
		LOG.log(Level.DEBUG, "Perform " + CommandType.APPROVE_LOT);
