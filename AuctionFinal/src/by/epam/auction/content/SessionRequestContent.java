    ...
    public SessionRequestContent(HttpServletRequest request) {
        ...
        if (request.getServletContext() != null) {
            servletContextPath = request.getServletContext()
                    .getRealPath(RegExpAndPatternHolder.EMPTY_STRING);
        }
    }

    /**
     * Gets the request Part#1
     * @return
     * @throws IOException
     * @throws ServletException
     */
    public Part getRequestPart1() throws IOException, ServletException {
        return request.getPart(REQUEST_PART_NAME_1);
    }
    /**
     * Gets the request Part#2
     * @return
     * @throws IOException
     * @throws ServletException
     */
    public Part getRequestPart2() throws IOException, ServletException {
        return request.getPart(REQUEST_PART_NAME_2);
    }
    
    /**
     * Gets the request Part#3
     * @return
     * @throws IOException
     * @throws ServletException
     */
    public Part getRequestPart3() throws IOException, ServletException {
        return request.getPart(REQUEST_PART_NAME_3);
    }
